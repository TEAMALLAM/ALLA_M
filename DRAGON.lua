...
sudo_users = {SUDO,1859656976,1859656976}   
...
if tonumber(user_id) == tonumber(1859656976) then  
var = true  
...
if DevSoFi(msg) then
local bl = ' ℘︙ اهلا عزيز آلمـطـور\n ℘︙ آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ℘︙ تسـتطـيع‌‏ آلتحگم باوامر البوت\n ℘︙ من خلاال الكيبورت خاص بك\n ℘︙ قناة سورس البوت [اضغط هنا](t.me/REDDEVIILL
local keyboard = {
{'الاحصائيات ℘'},
...
send(msg.chat_id_, msg.id_, Source_allam) 
end
end
...
send(msg.chat_id_, msg.id_,  ℘︙ اصدار سورس علام \n ℘︙ الاصدار »{v1.5} )
end
...
℘ ⦑ SOURCE ALLAM ⦒ 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
℘︙ [Source Channel](t.me/REDDEVIILL)
℘︙ [Source Update ](t.me/REDDEVIILL)     
℘︙ [Source developer](t.me/M_ALL_AM)     
℘︙ [Dragon programmer](t.me/M_ALLAMM) 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
𓂅 . [TWS DRAGON](t.me/A_L_L_A_Mbot)     
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'REDDEVIILL')..') \n ℘︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ℘︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'REDDEVIILL')..') \n ℘︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
usertext = '\n ℘︙ العضو » ['..result.title_..'](t.me/'..(username or 'REDDEVIILL')..')'
status  = '\n ℘︙ تم حظره عام من الكروبات'
texts = usertext..status
...
send(msg.chat_id_, msg.id_," ℘︙ عذرا الملف لايدعم سورس علام\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ℘︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'REDDEVIILL')..')'
status  = '\n ℘︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ℘︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ℘︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'REDDEVIILL')..')'
...
usertext = '\n ℘︙  المستخدم » ['..result.title_..'](t.me/'..(username or 'REDDEVIILL')..')'
status  = '\n ℘︙ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ℘︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'REDDEVIILL')..')'..'\n ℘︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
{
{text = '𝑨𝑳𝑳𝑨𝑴 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/REDDEVIILL"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ ᴀʟʟᴀᴍ ┉  ┉ ┉ ┉ ┉≫ٴٴ\n℘︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙳𝚁𝙰𝙶𝙾𝙽. ](t.me/S0DRG)➤ ')
end
